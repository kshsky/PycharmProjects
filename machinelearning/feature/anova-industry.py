...
# print('f-critical【F】:{},p-value:{}'.format(f_onewayResult.statistic,f_onewayResult.pvalue))
print('f-critical:{}',stats.f.ppf(0.95,3,19))
print('confidence:()',stats.f.cdf(f,3,19))