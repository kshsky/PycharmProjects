...
df=pd.read_csv("datafile/Facet_Data.csv")
...
p1=(ggplot(df, aes(x='SOD',y='tau',size='age')) + 
  geom_point(shape='o',color="black",
        ...
        aspect_ratio =1,
        dpi=100,
       figure_size=(4,12))) #shape=21,color="black",fill="red",size=3,stroke=0.1
print(p1)
p1.save("datafile/plotnine1.pdf")
...
p2=(ggplot(df, aes(x='SOD',y='tau',size='age',fill='age')) + 
  ...
  #scale_fill_distiller(type='seq', palette='blues') +
       ...
       figure_size=(4,12))) #shape=21,color="black",fill="red",size=3,stroke=0.1
print(p2)
p2.save("datafile/plotnine2.pdf")
...
p3=(ggplot(df, aes(x='SOD',y='tau',fill='Class')) + 
  ...
  #scale_fill_hue(s = 0.90, l = 0.65, h=0.0417,color_space='husl')+
       ...
       figure_size=(4,12))) #shape=21,color="black",fill="red",size=3,stroke=0.1
print(p3)
p3.save("datafile/plotnine3.pdf")
...
p4=(ggplot(df, aes(x='SOD',y='tau',size='age',fill='Class')) + 
  ...
  #scale_fill_hue(s = 0.90, l = 0.65, h=0.0417,color_space='husl')+
       ...
       figure_size=(4,12))) #shape=21,color="black",fill="red",size=3,stroke=0.1
print(p4)
p4.save("datafile/plotnine4.pdf")
